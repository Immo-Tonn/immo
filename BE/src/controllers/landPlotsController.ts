...
export const createLandPlot = async (
  ...
  try {
    ...
    console.log(
      '🔍 DEBUG LandPlotsData:',
      JSON.stringify(LandPlotsData, null, 2),
    );
    ...
    console.log(
      '🔍 DEBUG newLandPlot до сохранения:',
      JSON.stringify(newLandPlot.toObject(), null, 2),
    );
    ...
    console.log(
      '🔍 DEBUG savedLandPlot после сохранения:',
      JSON.stringify(savedLandPlot.toObject(), null, 2),
    );
    console.log(
      '🔍 DEBUG savedLandPlot.landPlottype:',
      savedLandPlot.landPlottype,
    );
