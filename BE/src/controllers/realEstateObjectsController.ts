...
// export const updateObject = async (req: Request, res: Response) => {
//   try {
//     console.log('Получен запрос на обновление объекта:', req.params.id);
...
//       { 
//         new: true,
//         runValidators: true // Включаем валидацию
//       },
//     );
...
//     console.log('Объект обновлен:', updated);

//     // Специальная обработка обновления порядка изображений
//     if (req.body.images) {
//       console.log('Порядок изображений обновлен:', req.body.images);
      
//       // Принудительно сохраняем изменения
//       await updated.save();
      
//       // Дополнительная верификация
//       const verification = await RealEstateObjectsModel.findById(req.params.id);
//       console.log('Верификация обновления - новый порядок изображений в БД:', verification?.images);
//     }
...
// //       // Дополнительная верификация
// //      const verification = await RealEstateObjectsModel.findById(req.params.id);
// //      console.log('Update verification - new order of images in the database:');
// //     }
