...
const PrivacyPolicy = () => {
  return (
    <div className={styles.container}>
      ...
      <h3>Maßgebliche Rechtsgrundlagen nach der DSGVO:</h3>
      <p>
      ...
      <p>
        ...
        TLS-/SSLVerschlüsselungstechnologie. Secure Sockets Layer (SSL) und
      ...
      <p>
        ...
        Angemessenheitsbeschluss der EUKommission vom 10.07.2023 als sicherer
      ...
      <h3>Aufbewahrung und Löschung von Daten:</h3>
      <p>
        Die folgenden allgemeinen Fristen gelten für die Aufbewahrung und
      ...
      <ul>
        ...
        <li>
          ...
          Gewährleistungsund Schadensersatzansprüche oder ähnliche vertragliche
          Ansprüche und Rechte zu berücksichtigen sowie damit verbundene
          Anfragen zu bearbeiten, basierend auf früheren Geschäftserfahrungen
          und üblichen Branchenpraktiken, werden für die Dauer der regulären
          gesetzlichen Verjährungsfrist von drei Jahren gespeichert (§§ 195, 199
          BGB).
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          einer Datenschutzaufsichtsbehörde, insbesondere einer Aufsichtsbehörde
          im Mitgliedstaat, in dem Sie sich gewöhnlich aufhalten, der
          Aufsichtsbehörde Ihres Arbeitsplatzes oder des Ortes des mutmaßlichen
          Verstoßes, eine Beschwerde einzulegen, wenn Sie der Ansicht sei
          sollten, dass die Verarbeitung der Ihre Person betreffenden
      ...
      <p>
        ...
        Hilfsdiensten sowie Subunternehmern, Banken, Steuerund Rechtsberatern,
      ...
      <ul>
        ...
        <li>
          ...
          6 Abs. 1 S. 1 lit. b) DSGVO); Rechtliche Verpflichtung (Art. 6 Abs. 1
          S. 1 lit. c) DSGVO). Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
          f) DSGVO).
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          finanziellen Situation sein. Sofern für die Vertragserfüllung oder
          gesetzlich erforderlich bzw. durch die Kunden bewilligt oder auf
          Grundlage auf unserer berechtigten Interessen basierend, offenbaren
          oder übermitteln wir die Daten der Kunden im Rahmen von
          Deckungsanfragen, Abschlüssen und der Abwicklung von Verträgen an
          ...
          wie z. B. Untervermittler; Rechtsgrundlagen: Vertragserfüllung und
          vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO).
        </li>
        <li>
          Finanzdienstleistungen: Wir verarbeiten die Daten unserer Kunden, um
          ihnen die Beratung, Vermittlung sowie den Abschluss von
          Finanzgeschäften und damit verbundenen Dienstleistungen zu
          ermöglichen. Die erforderlichen Angaben sind als solche im Rahmen der
          Beratungs-, Vermittlungs- bzw. vergleichbaren Vertragsschlusses
          ...
          halten zu können. Soweit wir Zugang zu Informationen der Kunden oder
        ...
        <li>
          ...
          von Mietinteressenten entsprechend dem zugrundeliegenden Mietvertrag.
          Wir können ferner die Angaben zu den Eigenschaften und Umständen von
          Personen oder ihnen gehörenden Sachen verarbeiten, wenn dies im Rahmen
          des Mietverhältnisses erforderlich ist. Dies können z. B. Angaben zu
          persönlichen Lebensumständen, mobilen oder immobilen Sachgütern und
          zur finanziellen Situation sowie der Inanspruchnahme von
          Nebenleistungen (wie der Wasser- oder Energieversorgung) sein.
        </li>
      </ul>
      ...
      <p>
        ...
        Verarbeitung erfolgt, um die gesundheitlichen Interessen der Mieter
      ...
      <p>
        ...
        Rahmen von Deckungsanfragen, Abschlüssen und Abwicklungen von Verträgen,
        z. B. an Finanzdienstleister, Kreditinstitute, Versorgern (z. B. Strom)
        oder Behörden
      </p>

      <p>
        Ferner verarbeiten wir Daten der Mieter, falls dies zur Erfüllung von
        gesetzlichen Pflichten erforderlich ist (z. B. bei Informationspflichten
        in Verbindung mit Nebenleistungen sowie den Nebenkosten);
      ...
      <ul>
        <li>
          ...
          Logins oder den Abruf von Daten oder Zugriffszeiten.); Nutzungsdaten
        ...
        <li>
          ...
          Geschäftsprozesse und betriebswirtschaftliche Verfahren;
          Kommunikation; Marketing; Absatzförderung; Öffentlichkeitsarbeit;
        ...
        <li>
          Rechtsgrundlagen: Vertragserfüllung und vorvertragliche Anfragen (Art.
          6 Abs. 1 S. 1 lit. b) DSGVO); Berechtigte Interessen (Art. 6 Abs. 1 S.
          1 lit. f) DSGVO). Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c)
          DSGVO).
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          Kontaktinformationen, Überwachung der Datenintegrität, Implementierung
          von Datenschutzmaßnahmen, Sicherstellung der Zugriffskontrollen,
          Durchführung von Backups und Wiederherstellungen der Kontaktdaten,
          Schulung von Mitarbeitern im effektiven Umgang mit
        ...
        <li>
          ...
          Zahlungsvorgängen, der Überwachung von Bankkonten und der Kontrolle
          von Zahlungsströmen erforderlich sind (z. B. Erstellung und Prüfung
          von Überweisungen, Abwicklung des Lastschriftverkehrs, Kontrolle von
        ...
        <li>
          ...
          die bei der Erfassung, Bearbeitung und Kontrolle von
        ...
        <li>
          ...
          Verwaltung und Kontrolle von finanzrelevanten Geschäftsvorfällen sowie
          bei der Berechnung, Meldung und Zahlung von Steuern erforderlich sind
          (z. B. Kontierung und Verbuchung von Geschäftsvorfällen, Erstellung
          von Quartalsund Jahresabschlüssen, Durchführung des Zahlungsverkehrs,
          Abwicklung des Mahnwesens, Kontenabstimmung, steuerliche Beratung,
          Erstellung und Einreichung von Steuererklärungen, Abwicklung des
          Steuerwesens); Rechtsgrundlagen: Vertragserfüllung und vorvertragliche
          Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Rechtliche Verpflichtung
          (Art. 6 Abs. 1 S. 1 lit. c) DSGVO), Berechtigte Interessen (Art. 6
          Abs. 1 S. 1 lit. f) DSGVO).
        </li>
        <li>
          Marketing, Werbung und Absatzförderung: Verfahren, die im Rahmen von
          Marketing, Werbung und Absatzförderung erforderlich sind (z. B.
        ...
        <li>
          ...
          Pressemitteilungen, Pflege vonMedienkontakten, Monitoring und Analyse
          ...
          Corporate Branding); Rechtsgrundlagen: Berechtigte Interessen (Art. 6
          Abs. 1 S. 1 lit. f) DSGVO).{' '}
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          IPAdressen, Zeitangaben, Identifikationsnummern, beteiligte Personen);
      ...
      <ul>
        ...
        <li>
          ...
          betreffend den EMailversand (z. B. die beteiligten Provider) sowie die
          Inhalte der jeweiligen EMails verarbeitet. Die vorgenannten Daten
        ...
        <li>
          ...
          Grafiken oder Programm-Skripte mit Hilfe regional verteilter und über
      ...
      <p>
        ...
        Einwilligung ab. Liegt eine Einwilligung vor, dient sie als
      ...
      <ul>
        ...
        <li>
          ...
          des Endgeräts gespeichert. So können beispielsweise der Log-inStatus
          gespeichert und bevorzugte Inhalte direkt angezeigt werden, wenn der
          Nutzer eine Website erneut besucht. Ebenso können die mithilfe von
          Cookies erhobenen Nutzerdaten zur Reichweitenmessung Verwendung
...
"
      ...
      <p>
        Rechtsgrundlagen: Die Verarbeitung von Daten, die für die Bereitstellung
        der Funktionalitäten der Applikation erforderlich ist, dient der
        ...
        Freigaben von Gerätefunktionen) voraussetzt. Sofern die Verarbeitung von
        ...
        Zwecken der Optimierung der Applikation oder Sicherheitszwecken),
        erfolgt sie auf Grundlage unserer berechtigten Interessen. Sofern Nutzer
        ausdrücklich deren Einwilligung in die Verarbeitung ihrer Daten gebeten
        werden, erfolgt die Verarbeitung der von der Einwilligung umfassten
      ...
      <ul>
        <li>
          ...
          Vertragsgegenstand, Laufzeit, Kundenkategorie). Standortdaten (Angaben
      ...
      <ul>
        ...
        <li>
          Speicherung eines pseudonymen Identifikators: Damit wir die
          Applikation bereitstellen und ihre Funktionsfähigkeit sicherstellen
          können, verwenden wir einen pseudonymen Identifikator. Der die
          Identifikation ist ein mathematischer Wert (d. .h. es werden keine
          Klardaten, wie z. B. Namen verwendet), der einem Gerät und/ oder der
          auf ihm installierten Installation der Applikation zugeordnet ist.
          Dieser Identifikator wird bei der Installation dieser Anwendung
          generiert, bleibt zwischen dem Start der Applikation sowie ihrer
          Aktualisierungen gespeichert und wird gelöscht wenn Nutzer die
        ...
        <li>
          ...
          jederzeit inden Einstellungen der jeweiligen Geräte widerrufen werden.
          Das genaue Verfahren zur Kontrolle der App-Berechtigungen kann vom
          Gerät und der Software der Nutzern abhängig sein. Bei
        ...
        <li>
          Verarbeitung von gespeicherten Kontakten: Im Rahmen der Nutzung
          unserer Applikation werden die in dem Kontaktverzeichnis des Gerätes
          gespeicherten Kontaktinformationen von Personen (Name, E-Mail-Adresse,
          Telefonnummer) verarbeitet. Die Nutzung der Kontaktinformationen setzt
          eine Berechtigung der Nutzer, die jederzeit widerrufen werden kann,
          voraus. Die Nutzung der Kontaktinformationen dient jeweils nur der
          ...
          typischen und erwartbaren Funktionsweise. Die Nutzer werden darauf
          hingewiesen, dass die Erlaubnis der Verarbeitung der
          Kontaktinformationen erlaubt sein muss und insbesondere bei
          natürlichen Personen deren Einverständnisses oder einer gesetzlichen
          Erlaubnis bedarf.
        </li>
        <li>
          Nutzung von Kontaktdaten zu Zwecken des Kontaktabgleichs: Die im
          Kontaktverzeichnis des Gerätes gespeicherten Daten von Kontakten
          können genutzt werden, um zu prüfen, ob diese Kontakte auch unsere
          Applikation nutzen. Zu diesem Zweck werden die Kontaktdaten der
          jeweiligen Kontakte (zu denen die Telefonnummer und E-Mailadresse
          sowie die Namen gehören) auf unseren Server hochgeladen und nur für
          den Zweck des Abgleichs verwendet.
        </li>
        <li>
          Verarbeitung von Standortdaten: Im Rahmen der Nutzung unserer
          Applikation werden die von dem verwendeten Gerät erhobenen oder sonst
          durch die Nutzer eingegebenen Standortdaten verarbeitet. Die Nutzung
          der Standortdaten setzt eine Berechtigung der Nutzer, die jederzeit
          widerrufen werden kann, voraus. Die Nutzung der Standortdaten dient
          jeweils nur der Bereitstellung der jeweiligen Funktionalität unserer
          Applikation, entsprechend ihrer Beschreibung gegenüber den Nutzern,
          bzw. ihrer typischen und erwartbaren Funktionsweise.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          OnlineFormular). Bereitstellung unseres Onlineangebotes und
      ...
      <ul>
        <li>
          ...
          EMail oder anderen Kommunikationswegen, verarbeiten wir die uns
          ...
          Kontaktaufnahme und Kommunikation; Rechtsgrundlagen: Vertragserfüllung
      ...
      <p>
        ...
        Rahmen von Webanalyse, A/BTestings und Optimierung keine Klardaten der
      ...
      <ul>
        ...
        <li>
          ...
          Klickverfolgung; A/B-Tests. Heatmaps (Mausbewegungen seitens der
          Nutzer, die zu einem Gesamtbild zusammengefasst werden.).
        </li>
        <li>
          Aufbewahrung und Löschung: Löschung entsprechend Angaben im Abschnitt
          "Allgemeine Informationen zur Datenspeicherung und Löschung".
          Speicherung von Cookies von bis zu 2 Jahren (Sofern nicht anders
          angegeben, können Cookies und ähnliche Speichermethoden für einen
      ...
      <ul>
        <li>
          ...
          keine individuellen IPAdressen für EU-Nutzer. Analytics stellt jedoch
        ...
        <li>
          ...
          Einwilligungsdialogs erteilte Einwilligung (auch bekannt als
          "CookieOpt-In/Einwilligung", 'Cookiebanner', etc.) erfüllt mehrere
          Zwecke. Zum einen dient sie uns zur Erfüllung unserer Pflicht, eine
          Einwilligung in die Speicherung und das Auslesen von Informationen auf
          und vom Endgerät der Nutzer (gemäß ePrivacy-Richtlinien) einzuholen.
          Zum anderen deckt sie die Verarbeitung personenbezogener Daten der
          Nutzer entsprechend den Datenschutzvorgaben ab. Zudem gilt diese
          Einwilligung auch für Google, da das Unternehmen nach dem Gesetz über
          digitale Märkte verpflichtet ist, eine Einwilligung für
          personalisierte Dienste einzuholen. Daher teilen wir den Status der
          von Nutzern erteilten Einwilligungen mit Google. Unsere
          Einwilligungsverwaltungssoftware informiert Google darüber, ob
          Einwilligungen erteilt wurden oder nicht. Ziel ist es,
          sicherzustellen, dass die erteilten oder nicht erteilten
          Einwilligungen der Nutzer bei der Nutzung von Google Analytics und bei
          der Integration von Funktionen und externen Diensten berücksichtigt
          werden. So können Einwilligungen der Nutzer und deren Widerruf im
          Rahmen von Google Analytics und anderen Google Diensten in unserem
        ...
        <li>
          ...
          nicht direkt vom Endgerät der Nutzer an Google übermittelt.
          Insbesondere wird die IP-Adresse der Nutzer nicht an Google
          übermittelt. Stattdessen werden die Daten zunächst an unseren Server
          übermittelt, wo die Datensätze der Nutzer unserer internen
          ...
          Daten, wie Namen oder EMail-Adressen. Sie dient dazu,
          ...
          IPSuche erfasst werden: „Stadt" (und der abgeleitete Breiten- und
        ...
        <li>
          ...
          Sitzungsdaten von Websites und Apps, die Google mit Nutzern in
          Verbindung bringt, die sich bei ihren Google-Konten angemeldet und die
          ...
          Konversions-Messung zu ermöglichen. Dazu gehören:
          Plattformübergreifende Berichte - Verknüpfung von Daten über Geräte
          und Aktivitäten aus verschiedenen Sitzungen unter Verwendung Ihrer
          User-ID oder Google Signals-Daten, die ein Verständnis des
          Nutzerverhaltens bei jedem Schritt des Konversionsprozesses
          ermöglichen, vom ersten Kontakt bis zur Konversion und darüber hinaus;
          Remarketing mit Google Analytics - Erstellung von
          Remarketing-Zielgruppen aus Google Analytics-Daten und Weitergabe
          dieser Zielgruppen an verknüpfte Werbekonten; Demografien und
          Interessen - Google Analytics sammelt zusätzliche Informationen über
          demografische Daten und Interessen von Nutzern, die in ihren
        ...
        <li>
          ...
          um Anzeigen, die über Googles Werbedienste und die seiner Partner
          geschaltet werden, gezielt jenen Nutzern zu präsentieren, die bereits
          ...
          aufweisen. Diese Daten übermitteln wir an Google im Rahmen des
          sogenannten "Remarketing" oder der "Google-Analytics-Audiences". Ziel
          des Einsatzes von Remarketing Audiences ist es, sicherzustellen, dass
        ...
        <li>
          ...
          Onlineangeboten auf Grundlage von pseudonym durchgeführten Messungen
          und Analysen des Nutzerverhaltens, zu denen insbesondere A/B-Tests
          (Messung der Beliebtheit und Nutzerfreundlichkeit von
      ...
      <ul>
        <li>
          ...
          ein mutmaßliches Interesse an den Anzeigen haben. Darüber hinaus
          messen wir die Konversion der Anzeigen, d. h. ob die Nutzer sie zum
          Anlass genommen haben, mit den Anzeigen zu interagieren und die
          beworbenen Angebote zu nutzen (sog. Konversionen). Wir erhalten jedoch
        ...
        <li>
          ...
          GoogleAnzeigen klicken und anschließend die beworbene Dienstleistung
          in Anspruch nehmen (sog. "Konversion"), können die vom Nutzer
          eingegebenen Daten, wie z. B. die E-Mail-Adresse, der Name, die
          Wohnanschrift oder die Telefonnummer, an Google übermittelt werden.
          Die Hash-Werte werden dann mit bestehenden Google-Konten der Nutzer
      ...
      <ul>
        ...
        <li>
          ...
          Verarbeitung) von Daten der Besucher verantwortlich, die zur
          Erstellung der „PageInsights" (Statistiken) unserer LinkedIn-Profile
      ...
      <p>
        ...
        die IPAdresse der Nutzer verarbeiten, da sie ohne IP-Adresse die Inhalte
        nicht an deren Browser senden könnten. Die IP-Adresse ist damit für die
        Darstellung dieser Inhalte oder Funktionen erforderlich. Wir bemühen
        uns, nur solche Inhalte zu verwenden, deren jeweilige Anbieter die
        IP-Adresse lediglich zur Auslieferung der Inhalte anzuwenden.
      ...
      <ul>
        ...
        <li>
          ...
          interessens-/verhaltensbezogenes Profiling, Nutzung von Cookies);
          Zielgruppenbildung; Marketing. Erbringung vertraglicher Leistungen und
      ...
      <ul>
        ...
        <li>
          ...
          Schriftarten-Dateien zwecks einer nutzerfreundlichen Darstellung
          unseres Onlineangebotes; Dienstanbieter: Die Google Fonts werden auf
          unserem Server gehostet, es werden keine Daten an Google übermittelt;
          Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
          DSGVO).
        </li>
        <li>
          ...
          HTTPAnfragen an die Google Fonts Web API (d. h. eine
          ...
          Nutzer für den Zugriff auf das Internet verwendete IPAdresse, (2) die
          angeforderte URL auf dem Google-Server und (3) die HTTPHeader,
          einschließlich des User-Agents, der die Browser- und
          Betriebssystemversionen der Websitebesucher beschreibt, sowie die
          VerweisURL (d. h. die Webseite, auf der die Google-Schriftart
          ...
          (angeforderte URL, User-Agent und VerweisURL). Der Zugriff auf diese
        ...
        <li>
          ...
          Verweildauer auf Webseiten, zuvor besuchte Webseiten, Interaktionen
          ...
          Datenverarbeitung erfolgt auf Grundlage unserer berechtigten
        ...
        <li>
          ...
          YouTube-Videos erfolgt über eine spezielle Domain mithilfe der
          Komponente „youtube-nocookie" im sogenannten „erweiterten
          Datenschutzmodus". Im „erweiterten Datenschutzmodus" können bis zum
          Start des Videos lediglich Informationen, zu denen Ihre IP-Adresse
          sowie Angaben zum Browser und Ihrem Endgerät gehören, auf Ihrem
          Endgerät in Cookies oder mittels vergleichbarer Verfahren gespeichert
          werden, die YouTube für die Ausgabe, Steuerung und Optimierung der
          Videoanzeige benötigt. Sobald Sie die Videos abspielen, können
          zusätzlich Informationen zur Analyse des Nutzungsverhaltens sowie zur
          Speicherung im Nutzerprofil und zur Personalisierung von Inhalten und
          Anzeigen durch YouTube verarbeitet werden. Die Speicherdauer für die
      ...
      <ul>
        ...
        <li>
          ...
          einem Beschäftigungsverhältnis stehen, sei es als Mitarbeiter,
          Angestellte oder in ähnlichen Positionen. Ein Beschäftigungsverhältnis
          ist eine rechtliche Beziehung zwischen einem Arbeitgeber und einem
          Arbeitnehmer, die durch einen Arbeitsvertrag oder eine Vereinbarung
          festgelegt wird. Es beinhaltet die Verpflichtung des Arbeitgebers, dem
          ...
          Arbeitnehmer seine Arbeitstätigkeit ausübt, und die Beendigung, wenn
          das Beschäftigungsverhältnis endet, sei es durch Kündigung,
          Aufhebungsvertrag oder anderweitig. Beschäftigtendaten sind alle
          Informationen, die sich auf diese Personen beziehen und im Kontext
          ihrer Beschäftigung stehen. Dies umfasst Aspekte wie persönliche
          Identifikationsdaten, Identifikationsnummern, Gehalts- und Bankdaten,
          Arbeitszeiten, Urlaubsansprüche, Gesundheitsdaten und
          Leistungsbeurteilungen.
        </li>
        <li>
          Bestandsdaten: Bestandsdaten umfassen wesentliche Informationen, die
          für die Identifikation und Verwaltung von Vertragspartnern,
          Benutzerkonten, Profilen und ähnlichen Zuordnungen notwendig sind.
          Diese Daten können u.a. persönliche und demografische Angaben wie
        ...
        <li>
          ...
          Erstellung, Bearbeitung und Veröffentlichung von Inhalten aller Art
        ...
        <li>
          Plattformen und Medien veröffentlicht werden. Inhaltsdaten sind nicht
          nur auf den eigentlichen Inhalt beschränkt, sondern beinhalten auch
          Metadaten, die Informationen über den Inhalt selbst liefern, wie Tags,
        ...
        <li>
          ...
          und Instant-MessagingIdentifikatoren
        </li>
        <li>
        ...
        <li>
          ...
          Weise enthalten, wie Daten verarbeitet, übermittelt und verwaltet
          werden. Meta-Daten, auch bekannt als Daten über Daten, umfassen
        ...
        <li>
          ...
          verweilen und über welche Pfade sie durch eine Anwendung navigieren.
          Nutzungsdaten können auch die Häufigkeit der Nutzung, Zeitstempel von
          Aktivitäten, IPAdressen, Geräteinformationen und Standortdaten
        ...
        <li>
          ...
          des Profilings werden häufig Cookies und WebBeacons eingesetzt.
        </li>
        <li>
          ...
          Diese Daten enthalten typischerweise Informationen wie Zeitstempel,
        ...
        <li>
          Remarketing: Vom "Remarketing" bzw. "Retargeting" spricht man, wenn z.
          B. zu Werbezwecken vermerkt wird, für welche Produkte sich ein Nutzer
          auf einer Webseite interessiert hat, um den Nutzer auf anderen
          Webseiten an diese Produkte, z. B. in Werbeanzeigen, zu erinnern.
        </li>
        <li>
          Standortdaten: Standortdaten entstehen, wenn sich ein mobiles Gerät
          (oder ein anderes Gerät mit den technischen Voraussetzungen einer
          ...
          Position der Erde sich das jeweilige Gerät befindet. Standortdaten
          können z. B. eingesetzt werden, um Kartenfunktionen oder andere von
        ...
        <li>
          ...
          Verhaltensund Interessensinformationen in Cookies oder auf Servern der
          ...
          den Nutzern Werbeanzeigen anzuzeigen, die voraussichtlich deren
        ...
        <li>
          Vertragsdaten: Vertragsdaten sind spezifische Informationen, die sich
          auf die Formalisierung einer Vereinbarung zwischen zwei oder mehr
          ...
          Start- und Enddaten des Vertrages, die Art der
        </li>
        <li>
          ...
          rechtliche Grundlage für die Beziehung zwischen den Parteien und sind
          entscheidend für die Klärung von Rechten und Pflichten, die
