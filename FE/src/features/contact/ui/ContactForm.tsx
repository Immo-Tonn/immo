...
const ContactForm = () => {
  // ИСПРАВЛЕНО: Правильный тип для ref
  ...
  return (
    <div 
      ...
      ref={el => { refs.current[1] = el; }} // ИСПРАВЛЕНО: правильная функция ref
    >
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className={styles.captchaContainer}>
            <ReCAPTCHA
              hl="de"
              ref={recaptchaRef}
              sitekey={import.meta.env.VITE_RECAPTCHA_SITE_KEY || ''} // ИСПРАВЛЕНО: добавлен fallback
              size="normal"
              onChange={token => {
