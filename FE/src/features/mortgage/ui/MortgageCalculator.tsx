...
const MortgageCalculator = () => {
  ...
  // --- ВАЖНО! --- Получаем цену из перехода, если она есть
  useEffect(() => {
    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.col}>
          ...
          <button onClick={handleCalc} className={styles.btn}>
            Berechnen
          </button>
          <button onClick={exportPDF} className={styles.btn}>
            Export als PDF
          </button>
          {validationError && (
            <p className={styles.error}>
...
// --- renderSelect должен быть ВНЕ компонента! ---
